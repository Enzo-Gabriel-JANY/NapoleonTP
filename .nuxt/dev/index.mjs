...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/devalue/index.js';
import { renderSSRHead } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Développement/TP_Napoleon/napoleon-front/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Développement\\TP_Napoleon\\napoleon-front","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Développement\\TP_Napoleon\\napoleon-front\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Développement\\TP_Napoleon\\napoleon-front\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Développement\\TP_Napoleon\\napoleon-front\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Développement\\TP_Napoleon\\napoleon-front\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ppK16xdBGz = (function(nitro) {
...
const _lazy_Hw7Oq4 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Hw7Oq4, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Hw7Oq4, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/D%C3%A9veloppement/TP_Napoleon/napoleon-front/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
